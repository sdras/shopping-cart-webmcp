      ...
      <div className="product-dialog-body">
        ...
        <div className="product-detail">
          ...
          <div>
            ...
            <p className="product-detail-price">{money(priceAt(shop, product))}</p>
        ...
        {related.length > 0 && (
          <section aria-labelledby="related-title">
            <h3 id="related-title">More from {departmentsById[product.department].name}</h3>
